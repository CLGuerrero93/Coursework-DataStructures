/*
   A bank account has a balance and a mechanism for applying interest or fees
...
class BankAccount
{
   ...
   //Set account number.@param account number
   void setAccountNumber(int n);

   //Get account number. @return account number
   int getAccountNumber();
   
   //Makes a deposit. @param amount the amount of the deposit
   ...
   */
   /*this function should be override by subclasses, 
     for checking account, after every withdraw, the number of withdraws 
     should be decreased
